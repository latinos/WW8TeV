void ChargeRatioStyle()
{
  ...
  ChargeRatioStyle->SetLabelOffset(0.024, "xyz");
  ChargeRatioStyle->SetLabelSize  (0.020, "xyz");

  ChargeRatioStyle->SetNdivisions (  505, "xyz");
  ChargeRatioStyle->SetTitleFont  (   42, "xyz");
  ChargeRatioStyle->SetTitleSize  (0.030, "xyz");

  //  ChargeRatioStyle->SetNdivisions ( -503, "y");

  ChargeRatioStyle->SetTitleOffset(  2,   "x");
  ChargeRatioStyle->SetTitleOffset(  2,   "y");
  ...
  ChargeRatioStyle->SetTitleFontSize(0.035);
